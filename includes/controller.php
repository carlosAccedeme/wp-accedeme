...
class Accedeme_REST_Widget_Controller extends WP_REST_Controller
{
    /**
     * @const string
     */
     ...
     * @var string
     */
    protected $namespace = 'accedeme/v1';
    /**
     * @var string
     */
    protected $tableName;
    ...
    function __construct()
    {
        ...
        $this->tableName = $wpdb->prefix . 'accedeme';
    }
        ...
        try {
            ...
            $response = [
                ...
                'accedeme' => [
                    ...
                    'tableExist' => $accedeme_table_exist,
                ],
            ];
        } catch (Exception $e) {
 ...
 *
 */
function accedeme_register_rest_routes()
{
    $controller = new Accedeme_REST_Widget_Controller();
    $controller->register_routes();
}

add_action('rest_api_init', 'accedeme_register_rest_routes');
